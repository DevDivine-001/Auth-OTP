...
flex object-cover flex-wrap">
  <input maxLength={1}  className="w-[15%] h-[5vh] justify-center items-center
flex object-cover bg-transparent rounded-[4px] text-center border-[1px] border-[#0000ff] spin-button-none" {...register("number")} required/>
  <input type="text" maxLength={1} className="w-[15%] h-[5vh] justify-center items-center
